...
const AssignSaleperson = async (orderSummaryId,userId) =>{
    try {
        ...
        const result = await pool.query(sqlQuery.assignSaleperson,[orderSummaryId,userId]);            
         return {success:true};
...
module.exports={AddOrderSummaryToDB,UpdateOrderStatus,GetOrdersByCustomer,GetOrdersByStatus,AssignSaleperson}